            ...
            <div class="card-body">
                <form method="post" action="?c=auth&a=registruj">
                    ...
                    <div class="col-sm-10 pb-3">
                        <input type="email" class="form-control" name="email" id="regInputEmail" maxlength="70" required>
                    </div>

                    <label for="regInputMeno" class="form-label text-dark">Meno</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="meno" id="regInputMeno" pattern="^[a-zA-Z ]*$" maxlength="50" required>
                    </div>
